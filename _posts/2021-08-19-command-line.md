...
In the example in [*KivaKit applications*]({% post_url 2021-08-10-applications %}), the argument and switch parsers returned by the example application were declared like this:
