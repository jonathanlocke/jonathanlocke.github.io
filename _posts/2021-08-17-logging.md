...
KivaKit departs from these frameworks because KivaKit *Logger*s participate in [*messaging*]({% post_url 2021-07-07-broadcaster %}). A *Logger* in KivaKit is a *Listener* which can receive and log any kind of (*Transmittable*) *Message*:
