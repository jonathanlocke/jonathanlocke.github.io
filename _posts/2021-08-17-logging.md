...
KivaKit departs from these frameworks because KivaKit *Logger*s participate in [*messaging*](/broadcaster.md). A *Logger* in KivaKit is a *Listener* which can receive and log any kind of (*Transmittable*) *Message*:
